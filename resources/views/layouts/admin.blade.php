        ...
        <div class="flex flex-col w-64 border-r border-slate-800 bg-slate-900 text-slate-300 shadow-xl z-20">
            ...
            <div class="flex-1 flex flex-col overflow-y-auto py-6">
                <nav class="flex-1 px-4 space-y-1.5">
                    ...
                    <a href="/admin/kategori" class="{{ request()->is('admin/kategori*') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }} group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                        Manajemen Kategori
                    </a>
                    <a href="/admin/paket" class="{{ request()->is('admin/paket*') ? 'bg-slate-800 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }} group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors">
                        Manajemen Paket
                    </a>
